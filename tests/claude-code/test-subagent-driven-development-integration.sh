...
mkdir -p src test docs/spsa/changes/implementation

# Create a simple implementation plan
cat > docs/spsa/changes/implementation/plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/spsa/changes/implementation/plan.md using the subagent-driven-development skill.
...
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/spsa/changes/implementation/plan.md using the subagent-driven-development skill.
