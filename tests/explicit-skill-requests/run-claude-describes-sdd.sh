...
mkdir -p "$PROJECT_DIR/docs/spsa/changes/auth-system"
...
# Create a plan
cat > "$PROJECT_DIR/docs/spsa/changes/auth-system/plan.md" << 'EOF'
...
claude -p "I have a plan at docs/spsa/changes/auth-system/plan.md. Tell me about my options for executing it, including what subagent-driven-development means and how it works." \
    --model haiku \
